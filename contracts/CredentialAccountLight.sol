...
contract CredentialAccountLight {
    ...
    modifier onlyActiveSubscription(
        SubscriptionServiceLight _subscriptionService
    ) {
        require(
    ...
    modifier notEarlyPayment(SubscriptionServiceLight _subscriptionService) {
        require(
            block.timestamp >=
